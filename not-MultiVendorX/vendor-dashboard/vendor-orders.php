    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="order_search pull-right">
                <input type="text" aria-label="search term" class="pro_search_key no_input form-control inline-input" id="pro_search_key" name="search_keyword" />
            ...
            <form method="post" name="mvx_vendor_dashboard_completed_stat_export" id="mvx_order_list_form">
                <div class="order-filter-actions alignleft actions">
                    <select id="order_bulk_actions" name="bulk_action" aria-label="bulk actions" class="bulk-actions form-control inline-input">
                    ...
                    <!-- bulk action options removed here because not relevant to digital products -->
                </div><br>
                        ...
                        <?php 
                            if($orders_list_table_headers) :
                                foreach ($orders_list_table_headers as $key => $header) {
                                    if($key == 'select_order'){ ?>
                            <th class="<?php if(isset($header['class'])) echo $header['class']; ?>"><input type="checkbox" aria-label="select all" class="select_all_all" onchange="toggleAllCheckBox(this, 'mvx-vendor-orders');" /></th>
                                <?php }else{ ?>
