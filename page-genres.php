...
<div class="two-thirds-screen generic-content">
    <div class="genre-category categories--top-level page-accent-alt-1"><a href="<?php echo esc_url(site_url('/product-category/fiction-ebooks'));?>">Fiction</a>
        ...
        <div class="not-displayed category-children">
            ...
            <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/fiction-ebooks/political-fiction'));?>">Political Fiction</a></div>
            ...
            <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/fiction-ebooks/science-fiction'));?>">Science Fiction</a>
                <i class="fa-solid fa-caret-down arrow"></i>    
                <div class="not-displayed category-children">
                <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/fiction-ebooks/science-fiction/adventure-science-fiction'));?>">Adventure science Fiction</a></div>
                    ...
                    <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/fiction-ebooks/science-fiction/technological-science-fiction'));?>">Technological Science Fiction</a></div>
    ...
    <div class="genre-category categories--top-level page-accent-alt-1"><a href="<?php echo esc_url(site_url('/product-category/nonfiction'));?>">Nonfiction</a>
        ...
        <div class="not-displayed category-children">
                ...
                <div class="not-displayed category-children">
                    ...
                    <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/fiction-ebooks/history/american-history'));?>">American History</a>
                        ...
                        <div class="not-displayed category-children">
                            ...
                            <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/fiction-ebooks/history/american-history/history-of-labor-in-america'));?>">History of Labor in America</a></div>
            ...
            <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/nonfiction/mental-health-and-psychology'));?>">Mental Health and Psychology</a></div>
            ...
            <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/nonfiction/spirituality'));?>">Spirituality</a>
                <i class="fa-solid fa-caret-down arrow"></i>    
                <div class="not-displayed category-children">
                    <div class="genre-category subcategory"><a href="<?php echo esc_url(site_url('/product-category/fiction-ebooks/spirituality/hindu-spirituality'));?>">Hindu Spirituality</a></div>
                </div>
            </div>
