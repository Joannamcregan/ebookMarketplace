...
?><main>
    <div class="generic-content">
        <h1>Welcome to Our Cooperatively Run Book Marketplace!</h1>
        <p class="right-text">
            When you shop here, you're empowering authors. <a href="<?php echo esc_url(site_url('/about'));?>"><span class="nowrap">Learn how.</span></a>
        </p>
    </div>
    ...
    if ($curation0->have_posts()){
        ?><div>
            <a class="gray-link" href="<?php echo get_the_permalink($curationId0); ?>"><h2 class="centered-text sans-text"><?php echo get_the_title($curationId0); ?></h2></a>
    ...
    if ($curation1->have_posts()){
        ?><div>
            <a class="gray-link" href="<?php echo get_the_permalink($curationId1); ?>"><h2 class="centered-text sans-text"><?php echo get_the_title($curationId1); ?></h2></a>
    ...
    if ($featuredShort->have_posts()){
        ?><div class="short-piece">
            <h2 class="centered-text sans-text">Featured Free Short</h2>
