    ...
    <div class="two-thirds-screen">
        ...
        <div class="max-1000-screen">
            <?php if (is_user_logged_in()){
                ...
                <?php } else {
                    ?><p class="centered-text">To view the Copyright Primer, join our Cooperative as a <a href="<?php echo esc_url(site_url('/creators-circle-membership'));?>">Creator-Member</a>.</p>
                <?php }
            }
        ?></div>
    </div>
