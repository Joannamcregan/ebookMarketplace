...
function ebook_marketplace_single_product_main_closing_div(){
    echo '</div>';
}
add_action('woocommerce_after_single_product_summary', 'ebook_marketplace_single_product_main_closing_div', 10);
...
function ebook_marketplace_triggers_product_tab_content(){
    ...
    echo '<p>' . 'Have you read this book and identified something in it that you think could be triggering for readers with a certain sensitivity?';
}
