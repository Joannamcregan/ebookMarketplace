...
?><main>
    <div class="two-thirds-screen">
        <div class="banner"><h1 class="centered-text banner-heading-32">Discussions</h1></div>
        <?php if (is_user_logged_in()){
            ...
            if ((in_array( 'reader-member', (array) $user->roles )) || (in_array( 'creator-member', (array) $user->roles ))){
                ?><div class="tomc-circle-container">
                    ...
                    <p class="tomc-circle-p-2">Discuss reading, creating, and community with other co-op members here.</p>
                </div>
            ...
            ?><div class="tomc-circle-container tomc-circle-container-long-text">
                ...
                <p class="tomc-circle-p-2">Members and non-members can talk about books and more here.</p>
            </div>
        <?php } else {
