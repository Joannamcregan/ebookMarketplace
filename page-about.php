...
?><main>
    ...
    <div class="generic-content two-thirds-screen">
        ...
        <div class="circle-bio-pic-wrapper">
            <picture>
                <source type="image/webp" srcset="<?php echo get_theme_file_uri('/images/Zia.webp'); ?>" alt="Black woman expressing joy"  class="circle-bio-pic" >
                <img alt="Black woman expressing joy" src="<?php echo get_theme_file_uri('/images/Zia.jpg'); ?>"  class="circle-bio-pic" />
            </picture>
        </div>
        ...
        <div class="circle-bio-pic-wrapper">
            <picture>
                ...
                <img alt="White woman with glasses stands in an art museum" src="<?php echo get_theme_file_uri('/images/joanna.jpg'); ?>" class="circle-bio-pic" />
            </picture>
        </div>
        <h3 class="centered-text red-brown-text">Joanna Cregan</h3>
        <p>Founding Member. Developer.</p>
