...
add_action('rest_api_init', 'mVXtendIsbnRegisterRoute');

function mVXtendIsbnRegisterRoute() {
    register_rest_route('mvxtend/v1', 'checkIfISBNAssigned', array(
        'methods' => 'GET',
        'callback' => 'checkIfISBNAssigned'
    ));
}

function checkIfISBNAssigned($data){
