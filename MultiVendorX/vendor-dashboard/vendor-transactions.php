                    ...
                    <table id="vendor_transactions" class="get_mvx_transactions table table-striped table-bordered" width="100%">
                        <thead>
                            ...
                            <?php 
                                ...
                                <th class="<?php if(isset($header['class'])) echo $header['class']; ?>"><input type="checkbox" class="select_all_transaction" aria-label="select all transactions" onchange="toggleAllCheckBox(this, 'vendor_transactions');" /></th>
                                    <?php }else{ ?>
