    ...
    <div class="panel panel-default panel-pading">
        <div class="product-list-filter-wrap">
            <div class="form-group">
                ...
                <div class="product_search pull-right">
                    <input type="text" class="pro_search_key no_input form-control inline-input" id="pro_search_key" name="search_keyword" aria-label="search"/>
        ...
        <div class="product-filter-actions">
            <div class="alignleft actions">
                ...
                ?>
                <select aria-label="select bulk actions" id="product_bulk_actions" name="bulk_action" class="mvx-filter-dtdd mvx_product_bulk_actions form-control inline-input">
                ...
                <!-- <select id="product_cat" name="product_cat" class="mvx-filter-dtdd mvx_filter_product_cat form-control inline-input">
                    ...
                    // ?> -->
                <!-- </select> -->
                <select aria-label="filter by product type" id="product_types" name="product_type" class="mvx-filter-dtdd mvx_filter_product_types form-control inline-input">
            ...
            if ($products_table_headers) {
                foreach ($products_table_headers as $key => $value) {
                    if($key == 'select_product'){ ?>
                        <th class="text-center" data-lable="<?php echo $key ?>"><input type="checkbox" class="select_all_all" aria-label="select all" onchange="toggleAllCheckBox(this, 'product_table');" /></th>
                    <?php }else{ ?>
