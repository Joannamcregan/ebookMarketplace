        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="compare-stat-info">
                    ...
                    <select name="" aria-label="Choose the time range to compare your store's performance against" id="mvx_vendor_stats_report_filter" class="form-control" data-stats="<?php echo htmlspecialchars(wp_json_encode($vendor_report_data)); ?>">
                        <?php 
