        ...
        <form name="mvx_vendor_dashboard_stat_report" method="POST" class="stat-date-range form-inline">
            <div class="mvx_form1 ">
                <div class="panel-heading d-lg-flex">
                    <h2><?php esc_html_e('Select Date Range :', 'multivendorx'); ?></h2> 
                    <div class="form-group">
                        <input type="date" name="mvx_stat_start_dt" aria-label="starting date" value="<?php echo isset($_POST['mvx_stat_start_dt']) ? wc_clean($_POST['mvx_stat_start_dt']) : date('Y-m-01'); ?>" class="pickdate gap1 mvx_stat_start_dt form-control">
                    </div>
                    <div class="form-group">
                        <input type="date" name="mvx_stat_end_dt" aria-label="ending date" value="<?php echo isset($_POST['mvx_stat_end_dt']) ? wc_clean($_POST['mvx_stat_end_dt']) : date('Y-m-d'); ?>" class="pickdate mvx_stat_end_dt form-control">
                    </div>
                    <div class="form-group">
