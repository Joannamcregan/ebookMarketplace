...
?><main>
    <div class="two-thirds-screen">
        ...
        <div class="tomc-circle-container">
            ...
            <p class="orange-shadow-heading tankindred-text tomc-circle-p-1-padded-x"><a href="<?php echo esc_url(site_url('/creators-circle-membership'));?>"><strong>Creator</strong></a></p>
            <br><br>
